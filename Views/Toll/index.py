...
#from Views.Toll.Toll import Toll
...
class tollIndex:
    ...
    def show(self):
        ...
        b1.place(relx=0.5,rely=0.2,relwidth=0.5,relheight=0.1)
        ...
        c1.place(relx=0.5,rely=0.3,relwidth=0.5,relheight=0.1)
        ...
        d1.place(relx=0.5,rely=0.4,relwidth=0.5,relheight=0.1)
        ...
        e1.place(relx=0.5,rely=0.5,relwidth=0.5,relheight=0.1)
    ...
    def __save(self):
        ...
        instaceToll = Toll(self.nameValue.get(),self.valueBaseValue.get(),self.leftIncreValue.get(),self.rightIncreValue.get())
        instaceToll.save()
